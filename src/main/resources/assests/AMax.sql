...
-- Client Table
INSERT INTO Client (Client_ID, Name, Address, Phone_No, Email)
VALUES ('C001', 'Chamath Dilshan', '123 Main St, Galle', '0771234567', 'chamath@gmail.com'),
...
-- Project Table
INSERT INTO Project (Project_ID, Name, Start_date, End_date, Type, Status, Client_ID)
VALUES ('P001', 'Bridge Construction', '2025-01-01', '2025-06-30', 'Infrastructure', 'Ongoing', 'C001'),
...
-- Employee Table
INSERT INTO Employee (Employee_ID, Name, Phone_No, Address, Role)
VALUES ('E001', 'Jagath Perera', '0713745295', 'Colombo 03', 'Engineer'),
...
-- EmployeeDetails Table
INSERT INTO EmployeeDetails (Project_ID, Work_date, Work_Day_Count, Employee_ID)
VALUES ('P001', '2025-08-01', 5, 'E001'),
...
-- Payment Table
INSERT INTO Payment (Payment_ID, Project_ID, Date, Type, Amount)
VALUES ('PM001', 'P001', '2025-08-01', 'Advance', 50000.00),
...
-- Expenses Table
INSERT INTO Expenses (Expense_ID, Type, Amount, Date, Project_ID, Employee_ID)
VALUES ('EX001', 'Transport', 5000.00, '2025-08-01', 'P001', 'E001'),
...
-- Material Table
INSERT INTO Material (Material_ID, Name, Quantity_in_Stock, Unit)
VALUES ('MA001', 'Cement', '500', 'Bags'),
       ('MA002', 'Steel Rods', '200', 'Pieces'),
       ('MA003', 'Sand', '1000', 'Kg'),
       ('MA004', 'Bricks', '1500', 'Pieces'),
       ('MA005', 'Paint', '300', 'Liters');

-- MaterialUsage Table
INSERT INTO MaterialUsage (Usage_ID, Project_ID, Material_ID, Quantity_used, Date)
VALUES ('MU001', 'P001', 'MA001', '50', '2025-08-01'),
       ('MU002', 'P002', 'MA002', '20', '2025-08-02'),
       ('MU003', 'P003', 'MA003', '100', '2025-08-03'),
       ('MU004', 'P004', 'MA004', '150', '2025-08-04'),
       ('MU005', 'P005', 'MA005', '30', '2025-08-05');

-- Machine Table
INSERT INTO Machine (Machine_ID, Name, Status, Description)
VALUES ('MC001', 'Excavator', 'Active', 'Used for digging'),
...
-- MachineMaintenance Table
INSERT INTO MachineMaintenance (MMR_ID, Machine_ID, Date, Cost, Description)
VALUES ('MM001', 'MC001', '2025-08-01', 5000.00, 'Engine oil change'),
...
-- MachineDetails Table
INSERT INTO MachineDetails (Project_ID, Machine_ID)
VALUES ('P001', 'MC001'),
       ('P002', 'MC002'),
       ('P003', 'MC003'),
       ('P004', 'MC004'),
...
VALUES ('S001', 'Supreme Cement', 'Colombo 07', '0712312467', 'cement@supreme.com'),
...
-- MaterialBuy Table
INSERT INTO MaterialBuy (Payment_ID, Material_ID, Supplier_ID, Date, Unit_Amount, Quantity, Total_Price)
VALUES ('MB001', 'MA001', 'S001', '2025-08-01', 1200.00, '50', 60000.00),
       ('MB002', 'MA002', 'S002', '2025-08-02', 1500.00, '20', 30000.00),
       ('MB003', 'MA003', 'S003', '2025-08-03', 50.00, '100', 5000.00),
       ('MB004', 'MA004', 'S004', '2025-08-04', 25.00, '150', 3750.00),
       ('MB005', 'MA005', 'S005', '2025-08-05', 300.00, '30', 9000.00);

-- Report Table
INSERT INTO Report (Report_ID, Material_ID, Daily)
VALUES ('R001', 'MA001', '2025-08-01'),
       ('R002', 'MA002', '2025-08-02'),
       ('R003', 'MA003', '2025-08-03'),
       ('R004', 'MA004', '2025-08-04'),
       ('R005', 'MA005', '2025-08-05');